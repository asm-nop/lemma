...
const TheoremList: React.FC = () => {
  ...
  const [sortField, setSortField] = useState<'expiration' | 'reward'>('expiration');
    ...
    <div className="space-y-4">
      <div className="flex justify-end mb-4 space-x-2">
        ...
        >
          ...
          Sort by Expiration: {sortField === 'expiration' ? (sortAscending ? "Earliest First" : "Latest First") : ""}
        </button>
        <button
        ...
        >
          <ArrowUpDown className="mr-2 h-4 w-4" />
          Sort by Reward: {sortField === 'reward' ? (sortAscending ? "Lowest First" : "Highest First") : ""}
        </button>
      </div>
